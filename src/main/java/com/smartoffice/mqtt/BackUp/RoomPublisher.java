...
public class RoomPublisher {
    ...
    private static final String TOPIC_TEMPERATURE = "floor/room/temperature";
    private static final String TOPIC_HUMIDITY = "floor/room/humidity";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Send the messages
            publishMessage(TOPIC_TEMPERATURE, String.valueOf(temperature), 1, false);
            publishMessage(TOPIC_HUMIDITY, String.valueOf(humidity), 1, false);
